...
#v(0.3em)
#align(center)[
  #box(width: 75%, stroke: 1pt + customGreen, inset: 8pt, radius: 5pt)[
    #align(center)[
      #text(size: 9pt, weight: "bold")[
        ⇒ 1101.1001 $arrow.r.double$ $1.1011001 × 2^3$
...
#v(0.5em)
#align(center)[
  #text(size: 9pt)[⇒ Convert binary to Hexadecimal:]
]
...
#v(0.3em)
#align(center)[
  #box(width: 50%,  fill: customGreen, inset: 12pt, radius: 5pt)[
    #text(size: 14pt)[
...
#v(0.5em)
#align(center)[
  #box(width: 50%,  fill: customBlue,  inset: 12pt, radius: 5pt)[
    #text(size: 14pt)[
